...
struct AnvilWalletApp: App {
    ...
    @StateObject private var lockManager = SessionLockManager.shared
    ...
    var body: some Scene {
            ...
            ZStack {
                ContentView()
                    ...
                    .onAppear {
                        ...
                        lockManager.delegate = walletService
                        if walletService.isWalletCreated && !walletService.hasSessionPassword {
                            lockManager.lock()
                        }
                ...
                if lockManager.isLocked && walletService.isWalletCreated {
        ...
        .onChange(of: scenePhase) { _, newPhase in
            ...
            case .active:
                ...
                // Clear session password when lock triggers
